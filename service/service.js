...
function PortService($location) {
    ...
    self.projects = [
        ...
        {name: "Event Scout", img: "images/event.jpg", url: "https://comealongerica.github.io/event-scout-event-website/#!/home", github: "https://github.com/ComeAlongErica/event-scout-event-website", description: "An event finder application using TicketMaster API and AngularJS."},
        {name: "To-Do List", img: "images/todo.jpg", url: "https://comealongerica.github.io/todo-list-angular-js/", github: "https://github.com/ComeAlongErica/todo-list-angular-js", description: "An AngularJS application that displays, edits, and deletes to-dos."},

...
function PortService($location) {
    ...
    self.projects = [
        ...
        {name: "Shopping List", img: "images/grocery.jpg", url: "https://grocery-list-fun.herokuapp.com/", github: "https://github.com/ComeAlongErica/shopping-cart-database", description: "Use a database for shopping cart app, with front-end functionality."},  
    ]

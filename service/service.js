...
function PortService($location) {
    ...
    self.projects = [
        ...
        {name: "Shopping List", img: "images/grocery.jpg", url: "https://github.com/ComeAlongErica/shopping-cart-database", description: "Create a database for shopping cart app, with front-end functionality."},  
    ]

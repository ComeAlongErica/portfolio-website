...
function PortService($location) {
    ...
    self.projects = [
        ...
        {name: "Event Scout", img: "images/event.jpg", url: "https://comealongerica.github.io/event-scout-event-website/#!/home", github: "https://github.com/ComeAlongErica/event-scout-event-website", description: "An event finder application using TicketMaster API and Angular."},
